...
<form:form action="manager/workProgramme/activity/editcreate.do"  modelAttribute="activity">
	...
	<acme:textbox code="activity.startDate" placeholder="yyyy/MM/dd HH:mm" path="startDate" />
	<br />
	
	<acme:textbox code="activity.endDate" placeholder="yyyy/MM/dd HH:mm" path="endDate" />
	<br />
