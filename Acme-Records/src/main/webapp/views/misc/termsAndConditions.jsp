...
<jstl:if test="${language == 'en'}">
	<h2>Welcome to Acme Records</h2>
	<p>These terms and conditions outline the rules and regulations for the use of Acme Records's Website.</p> <br /> 
	
	<p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Acme Records's website 
	if you do not accept all of the terms and conditions stated on this page.</p>
	<p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
	and any or all Agreements: 'Client', 'You' and 'Your' refers to you, the person accessing this website
	and accepting the Reviewer’s terms and conditions. 'The Reviewer', 'Ourselves', 'We', 'Our' and 'Us', refers
	to our Reviewer. 'Party', 'Parties', or 'Us', refers to both the Client and ourselves, or either the Client
	or ourselves. All terms refer to the offer, acceptance and consideration of payment necessary to undertake
	the process of our assistance to the Client in the most appropriate manner, whether by formal meetings
	of a fixed duration, or any other means, for the express purpose of meeting the Client's needs in respect
	of provision of the Reviewer's stated services/products, in accordance with and subject to, prevailing law
	of . Any use of the above terminology or other words in the singular, plural,
	capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to same.</p>
	<h2>License</h2>
	<p>Unless otherwise stated, Acme Records and/or it's licensors own the intellectual property rights for
	all material on Acme Records. All intellectual property rights are reserved. You may view and/or print
	pages from https://Acme-Records.com for your own personal use subject to restrictions set in these terms and conditions.</p>
	<p>You must not:</p>
	<ol>
		<li>Republish material from https://Acme-Records.com</li>
		<li>Sell, rent or sub-license material from https://Acme-Records.com</li>
		<li>Reproduce, duplicate or copy material from https://Acme-Records.com</li>
	</ol>
	<p>Redistribute content from Acme Records (unless content is specifically made for redistribution).</p>
<h2>User Comments</h2>
	<ol>
		<li>This Agreement shall begin on the date hereof.</li>
		<li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
		material and data ('Comments') in areas of the website. Acme Records does not screen, edit, publish
		or review Comments prior to their appearance on the website and Comments do not reflect the views or
		opinions of Acme Records, its agents or affiliates. Comments reflect the view and opinion of the
		person who posts such view or opinion. To the extent permitted by applicable laws Acme Records shall
		...
		website.</li>
		<li>Acme Records reserves the right to monitor all Comments and to remove any Comments which it considers
		...
		<li>You hereby grant to <strong>Acme Records</strong> a non-exclusive royalty-free license to use, reproduce,
...
<h2>Hyperlinking to our Content</h2>
	...
	the visibility associated with the hyperlink outweighs the absence of Acme; and (d) where the
	...
	you must notify us by sending an e-mail to acme-conference@acme.com.
	...
	<p>No use of Acme Records's logo or other artwork will be allowed for linking absent a trademark license
	agreement.</p>
<h2>Iframes</h2>
...
<p> In compliance with the organic law 15/1999, of Personal Data Protection and its development normative, we inform to the owner users data, collected in case of access, navigability and/or use of the Web and/or Services, the data will be treat in a responsibility file from Acme Records, which goals are:
Manage the commercial relation with the User
Inform about new own products and services, that can be interesting, via e-mail or other similar electronic source , regular mailing, phone, fax, etc to the Users that have accepted the conditions to receive according to the law 34/2002, 11 July of Information Services and E-mail. Lingering the authoritation , according to the last supposed, including its relation with Acme Records as soon as it is not revoked. In case the User wants to stand against the commercial comunitacion rights the User must contact via e-mail acme_conference(@)gmail.com and express it especificaly.
Consent
The User will lend its consent to Acme Records, so the User data can be used properly for the cumpliment of the hired services.
The completion of the form and Terms and Conditions acceptance in the registration process via Web of Acme Records it implies the client consent expressly the insertion of the  personal data, ownership of Acme Records.
</p>
	<p></p>	
</jstl:if>
<jstl:if test="${language == 'es'}">
	<h2> Bienvenido a Acme Records </h2>
	<p> Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web de Acme Records. </p> <br />

	<p> Al acceder a este sitio web, asumimos que acepta estos términos y condiciones en su totalidad. No sigas utilizando la web de Acme Records.
	...
	<h2> Licencia </h2>
	<p> A menos que se indique lo contrario, Acme Records y / o sus licenciatarios poseen los derechos de propiedad intelectual de
	todo el material sobre Acme Records. Todos los derechos de propiedad intelectual están reservados. Usted puede ver y / o imprimir
	páginas de https://Acme-Records.com para su uso personal sujeto a las restricciones establecidas en estos términos y condiciones. </p>
	<p> No debes: </p>
	<ol>
		<li> Volver a publicar material desde https://Acme-Records.com </li>
		<li> Vender, alquilar o sub-licenciar material de https://Acme-Records.com </li>
		<li> Reproducir, duplicar o copiar material de https://Acme-Records.com </li>
	</ol>
	<p> Redistribuir el contenido de Acme Records (a menos que el contenido se haga específicamente para la redistribución). </p>
<h2> Comentarios de usuarios </h2>
	<ol>
		...
		Material y datos ('Comentarios') en áreas del sitio web. Acme Records no proyecta, edita, publica
		o comentarios de revisión antes de su aparición en el sitio web y comentarios no reflejan las vistas u
		opiniones de Acme Records, sus agentes o afiliados. Los comentarios reflejan la opinión y opinión de la
		persona que publica tal opinión. En la medida permitida por las leyes aplicables, Acme Records
		...
		sitio web. </li>
		<li> Acme Records se reserva el derecho de monitorear todos los comentarios y eliminar cualquier comentario que considere
		...
		<li> Por la presente, usted otorga a <strong> Acme Records </strong> una licencia no exclusiva sin royalties para usar, reproducir y
...
<h2> Hiperenlaces a nuestro contenido </h2>
	...
	la visibilidad asociada con el hipervínculo supera la ausencia de Acme; y (d) donde el
	...
	debe notificarnos enviando un correo electrónico a acme-conference@acme.com.
	Incluya su nombre, el nombre de su organización, información de contacto (como un número de teléfono y / o correo electrónico)
	...
	<p> No se permitirá el uso del logotipo de Acme Records u otra obra de arte para enlazar en ausencia de una licencia de marca registrada
	acordada. </p>
<h2> Iframes </h2>
...
<p> En cumplimiento de la Ley Orgánica 15/1999, de Protección de Datos de Carácter Personal y en su normativa de desarrollo, informamos al Usuario que sus datos, recabados en el caso de acceder, navegar, registrarse y/o utilizar la Web y/o los Servicios, serán tratados en un fichero responsabilidad de Acme Records, cuyas finalidades son:
Gestionar la relación comercial con el Usuario
Informarle de nuevos productos y servicios propios, que puedan ser de su interés, mediante correo electrónico o a través de otro medio de comunicación electrónica equivalente, correo ordinario, teléfono, fax, etc a aquellos Usuarios que hayan otorgado expresamente su consentimiento para la recepción de dichas comunicaciones de conformidad con la ley 34/2002, de 11 de julio de Servicios de la Información y del Comercio Electrónico. Perdurando su autorización, en relación con este último supuesto, incluso una vez concluida su relación con Acme Records en tanto no sea revocada. En caso de que quiere el Usuario quiere oponerse a los derechos de comunicación comercial deberá ponerse en contacto por medio de correo acme_conference(@)gmail.com y expresarlo específicamente.
Consentimiento
El usuario prestará su consentimiento para que Acme Records pueda hacer uso de sus datos personales a fin de prestar un correcto cumplimiento de los servicios contratados.
La cumplimentación del formulario y la aceptación de las Condiciones de servicio en el proceso de registro en la Web de Acme Records implica el consentimiento expreso del cliente a la inclusión de sus datos de carácter personal en el referido fichero, titularidad de Acme Records.
</p>
...
<form:form>
<button type="button" name="back" onclick="javascript: relativeRedir('welcome/index.do')">
	<spring:message code="misc.back" />
</button>
