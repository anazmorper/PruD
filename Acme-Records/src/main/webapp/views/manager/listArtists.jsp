...
<display:table pagesize="5" class="displaytag" keepStatus="true"
	...
	<display:column title="${artistHeader}">
		<a href="record/listbyartist.do?artistId=${row.id}"> <spring:message
				code="artist.record" />
		</a>
	</display:column> --%>
	...
	<security:authorize access="hasRole('MANAGER')">
		<display:column>
			<a href="artist/edit.do?artistId=${row.id}"><spring:message
					code="manager.artist.edit" /></a>

		</display:column>
		
		<display:column>
			<a href="artist/delete.do?artistId=${row.id}"><spring:message
					code="manager.artist.delete" /></a>
...
<security:authorize access="hasRole('MANAGER')">
	<div>
		<a href="artist/create.do"> <spring:message
				code="manager.artist.create" /></a>
	</div>
</security:authorize>
