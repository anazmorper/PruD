...
<display:table pagesize="5" class="displaytag" keepStatus="true"
	...
	<acme:column code="setter.finalMode" property="finalMode" />
...
<security:authorize access="hasRole('ADMIN')">
	...
	<jstl:if test="${row.finalMode=='false'}">
				<a href="administrator/setter/edit.do?setterId=${row.id}"><spring:message code="setter.edit"/></a>
	</jstl:if>	
	<jstl:if test="${row.finalMode=='true'}">
	<spring:message code="setter.isFinalMode" />
	</jstl:if>	
	</display:column>
</security:authorize>
...
<security:authorize access="hasRole('ADMIN')">
	<display:column>
	<jstl:if test="${row.finalMode=='false'}">
		<spring:message code="setter.delete" var="delete" />
			
				<a href="administrator/setter/delete.do?setterId=${row.id}" 
					   onclick="javascript: return confirm('<spring:message code="setter.confirm.delete" />')">
						<spring:message code="setter.delete" />
				</a>
	</jstl:if>
	<jstl:if test="${row.finalMode=='true'}">
	<spring:message code="setter.isFinalMode" />
